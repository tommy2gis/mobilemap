...
class App extends React.Component {
  ...
  renderLayers = (layers) => {
    ...
    const { themlist, selectedids } = this.props.thematics || {
      themlist: [],
      selectedids: [],
    };
  ...
  renderGetPosition = () => {
    ...
    return this.createMarker([map.center.x, map.center.y], {
      style: {
        iconGlyph: "number",
  ...
  drawSpatial = (type) => {
    switch (type) {
      case "point":
        ...
        break;
      case "polyline":
        this.props.changeDrawingStatus("start", "Line", "spatial", [], {});
        break;
      case "polygon":
        this.props.changeDrawingStatus("start", "Polygon", "spatial", [], {});
        break;
  ...
  clearThemetics = () => {
    this.props.thematics.selectedids.forEach((id) => {
      this.props.showThematicLayer(id, false);
    });
  };
        ...
        <div className="container">
          ...
          {userinfo && (
            <Drawer
              ...
              placement="left"
              className="userinfoDraw"
              onClose={this.onUserinfoDrawerClose}
